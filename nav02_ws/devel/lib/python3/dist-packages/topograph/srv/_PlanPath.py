...
"""autogenerated by genpy from topograph/PlanPathRequest.msg. Do not edit."""
import codecs
import sys
...
class PlanPathRequest(genpy.Message):
  _md5sum = "d2fe3a90855e60e74bfd7df48377622e"
  _type = "topograph/PlanPathRequest"
...
float64 w
"""
  __slots__ = ['start_pose','landmarks']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_7d().pack(_x.start_pose.position.x, _x.start_pose.position.y, _x.start_pose.position.z, _x.start_pose.orientation.x, _x.start_pose.orientation.y, _x.start_pose.orientation.z, _x.start_pose.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.start_pose.position.x, _x.start_pose.position.y, _x.start_pose.position.z, _x.start_pose.orientation.x, _x.start_pose.orientation.y, _x.start_pose.orientation.z, _x.start_pose.orientation.w,) = _get_struct_7d().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_7d():
    ...
    return _struct_7d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from topograph/PlanPathResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class PlanPathResponse(genpy.Message):
  ...
  _type = "topograph/PlanPathResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """
nav_msgs/Path path           
...
class PlanPath(object):
  _type          = 'topograph/PlanPath'
  _md5sum = 'ac039c3aab9885e2d76b26c6b9340c81'
